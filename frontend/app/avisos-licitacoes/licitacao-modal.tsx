...
export function LicitacaoModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal content */}
      <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-surface-container-lowest/95 dark:bg-surface-container/95 backdrop-blur-xl rounded-2xl shadow-ambient-lg animate-fade-in-up">
        {/* Header */}
        <div className="flex items-start justify-between p-5">
          ...
          <button
            onClick={onClose}
            className="flex-shrink-0 p-1.5 rounded-xl hover:bg-surface-container-high transition-colors text-on-surface-variant hover:text-on-surface"
          >
        ...
        <div className="flex items-center gap-3 p-5">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-on-surface-variant hover:bg-surface-container-high transition-all duration-200"
          >
          ...
          {editalUrl ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium bg-secondary text-on-secondary hover:bg-secondary/90 transition-all duration-200"
            >
